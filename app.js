/* =========================================================
   ...
   Semua request API lewat /api/proxy (backend sendiri)
   ========================================================= */
...
(function () {
  ...
  const TARGET_SEND   = 'https://api.alwayscodex.eu.cc/api/am/sendv2';
  const TARGET_VERIFY = 'https://api.alwayscodex.eu.cc/api/am/verifv2';
  ...
  async function apiRequest(targetUrl, payload) {
  ...
  function initSendForm() {
    ...
    form.addEventListener('submit', async function (e) {
      ...
      try {
        const result = await apiRequest(TARGET_SEND, { email: email });
  ...
  function initVerifyForm() {
    ...
    form.addEventListener('submit', async function (e) {
      ...
      try {
        const result = await apiRequest(TARGET_VERIFY, { email: email, link: link });
